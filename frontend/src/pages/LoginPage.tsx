...
export default function LoginPage() {
  // Pre-fill identifier from last remembered session
  const savedIdentifier = localStorage.getItem('email') || '';
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setAuth(access_token, user_id, email, role, remember);
  ...
  const handleGoogleSignIn = async () => {
    ...
    if (!supabaseUrl || supabaseUrl.includes('your-project-ref') ||
      ...
      toast.error('Google sign-in is not configured. Please set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in your .env file.');
      return;
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 to-blue-800">
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        ...
        <p className="text-center text-gray-600 mb-8">AI-powered CV generation</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="your@email.com or John Doe"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pr-11 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="••••••••"
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          ...
          <button
            ...
            className="w-full px-4 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
          >
